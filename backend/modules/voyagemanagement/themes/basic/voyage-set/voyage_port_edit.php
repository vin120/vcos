		...
		<div>
			...
			<p>
				<label>
					...
					<input type="text" id="s_time" name="s_time" placeholder="please choose"  value="<?php echo $voyage_port['EIA']?>" readonly></input>
				</label>
			</p>
			<p>
				<label>
					<span>Departure Time:</span>
					<input type="text" id="e_time" name="e_time" placeholder="please choose"  value="<?php echo $voyage_port['ETD']?>" readonly></input>
				</label>
			</p>
		</div>
		<div class="btn">
