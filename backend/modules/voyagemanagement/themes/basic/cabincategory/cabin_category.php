...
$("#bigclass").click(function(){
	location.href="<?php echo Url::toRoute(['cabin_category']);?>";
});
	   }
	$("input#cabininsert").click(function(){
		 location.href="<?php echo Url::toRoute(['cabincategory_option']);?>";
...
window.onload = function(){ 
   ...
   $(document).on('click',"#promptBox > .btn .confirm_but",function(){
	   ...
	   location.href="<?php echo Url::toRoute(['cabin_category']);?>"+"&code="+val;
   });
