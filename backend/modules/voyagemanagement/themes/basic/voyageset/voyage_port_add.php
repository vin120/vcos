		...
		<div>
			...
			<p>
				<label>
					...
					<input type="text" id="s_time" name="s_time" placeholder="please choose"  readonly onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss ',lang:'en'})" class="Wdate"  ></input>
				</label>
			</p>
			<p>
				<label>
					<span>Departure Time:</span>
					<input type="text" id="e_time" name="e_time" placeholder="please choose"  readonly onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss ',lang:'en'})" class="Wdate"  ></input>
				</label>
			</p>
		</div>
		<div class="btn">
