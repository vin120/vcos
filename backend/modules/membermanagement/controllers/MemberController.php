...
class MemberController extends Controller
{
   ...
   public function  mytrim()
   {
    ...
    public function actionIndex()
    {
      ...
      try{
        ...
        $Passport->delete();
        $transaction->commit();
        $this->show_message(yii::t ( 'vcos', 'delete suceess。' ),Url::to(['member/index']));
      } catch(Exception $e){
        $transaction->rollBack();//回滚事务
        $this->show_message(yii::t ( 'vcos', 'delete  failure' ),Url::to(['member/index']));
  ...
  $search_sql=" AND a.m_code like '%{$m_code}%'  AND a.m_name like '%{$m_name}%' AND a.country_code like '%{$country_code}%'";
  ...
  public function actionAdd_member()
  {
    ...
    public function actionMember_edit()
    {
      ...
      $sql="SELECT  a.*,b.date_expire ,b.date_issue,b.place_issue FROM  v_membership as a ,v_m_passport as b WHERE a.passport_number=b.passport_number AND  a.m_id='{$id}'";
    ...
    public function actionMember_add()
    {
    	...
    	$Membership->create_time=$create_time;
    	$Membership->balance=$balance;
          ...
          $Passport->date_issue=$date_issue;
          $Passport->date_expire=$date_expire;
          ...
          $transaction =\Yii::$app->db->beginTransaction();
                    try{
                        ...
                        $Passport->save();
                    $transaction->commit();
                    $this->show_message(yii::t ( 'vcos', 'add suceess' ),Url::to(['member/index']));
                    ...
                    $transaction->rollBack();//回滚事务
                    $this->show_message(yii::t ( 'vcos', 'add  failure，请注意格式' ),Url::to(['member/index']));
    ...
    public function actionMember_edit_save()
    {
      ...
      $Membership->passport_number=$passport_number;
        ...
        $this->show_message(yii::t ( 'vcos', 'update sucess' ),Url::to(['member/index']));
    		...
    		$transaction->rollBack();//回滚事务
    		$this->show_message(yii::t ( 'vcos', 'update failure' ),Url::to(['member/index']));
