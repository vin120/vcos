...
<div id="m_id" style="display: none;"><?php echo $member['m_id']?></div>
	...
	<div class="topNav">Route Manage&nbsp;&gt;&gt;&nbsp;<a href="#">Scenic Route</a></div>
		<form  method="post" id="member_edit_form" onkeydown="if(event.keyCode==13)return false;">
				...
				<div class="form">
					...
					<p>
						<label>
							...
							<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd ',lang:'en'})" class="Wdate"  value="<?php
					...
					<p>
						...
						<label>
							...
							<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',lang:'en'})" class="Wdate" value="<?php
			...
			<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd ',lang:'en'})" class="Wdate" >
		</div>
		<!-- content end -->
