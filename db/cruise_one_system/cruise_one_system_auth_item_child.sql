...
INSERT INTO `auth_item_child` VALUES ('超级管理员','admin'),('admin','author'),('gg','author'),('author','createpost'),('gg','createpost'),('testrole','createpost'),('超级管理员','createpost'),('admin','updatePost'),('testrole','updatePost'),('超级管理员','updatePost');
